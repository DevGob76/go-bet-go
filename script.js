...
function updateResultsStats() {
    ...
    // Calculer la moyenne de réussite
...
// Fonctions pour la page Archives Historique des Pronostics
...
// Initialiser la page Bilan Profit et Perte avec une ligne vide
document.addEventListener('DOMContentLoaded', function() {
    // All of the code that interacts with the DOM should be inside this block.
    ...
    document.getElementById('sportDropdown').addEventListener('change', function() {
        ...
        if (sport === 'football') {
            const championships = [
                ...
                // **Nouveaux championnats ajoutés en noir**
    ...
    // Ajouter une ligne vide si aucune donnée n'existe, après le chargement
...
// Initialiser la page Bilan Profit et Perte avec une ligne vide
// window.onload a été remplacé par DOMContentLoaded pour une meilleure gestion du chargement.
...
function updateProfitCalculations() {
    ...
    // Calculer le taux de profit total
...
function clearProfitLossData() {
    // Réinitialiser les données ajustables
    profitLossData = [];
